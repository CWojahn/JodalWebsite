<?php
$bg = array('restrito.jpg'); // array of filenames
...
<html >
    <head>
        <meta charset="utf-8">
        <title>Jodal - Acesso restrito</title>
                ...
                <div class="row text-center">
                    <div class="col-md-12 text-center" style="margin-top: 40px; margin-bottom: 10px">
                        <a href="<?php echo site_url(); ?>">
                            <img class="img-responsive" alt="..." src="<?php echo base_url('img/logo_nova.png'); ?>"></a>
                    </div>
                </div>
                <div>
                    <h4>
                    ...
                    <div style="margin-bottom: 20px">
                        ...
                        <form role="form" action="<?php echo site_url('verifylogin'); ?>" method="POST">
                            ...
                            <button type="submit" class="col-md-12 col-sm-12 btn btn-primary" style="margin-bottom: 20px;">Entrar</button>
                        </form>     
                    </div>
                </div>
