        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th class="text-center" style="width: 25%;">Técnico</th>
            ...
            <tbody>
                ...
                if (isset($relatorios)) {
                    ...
                    foreach ($relatorios as $relatorio) {
                        ...
                        <tr>
                            <!--<td class="text-center" style="width: 10%;"><input type="radio" name="radio" required value="<?php echo $relatorio->id; ?>"></td>-->
                            <td class="text-center" style="width: 25%;">
                                <a href="<?php echo base_url('uploads/relatorios/' . $relatorio->path_pdf); ?>" class="btn btn-success" title="Imprimir" target="_blank"><span class="glyphicon glyphicon-print"></span></a>
                            ...
                            <td class="text-center" style="width: 10%;"><?php echo $relatorio->id; ?></td>
                            <td class="text-center" style="width: 10%;"><?php echo date("d/m/Y", strtotime($relatorio->data)); ?></td>
                            <td class="text-center" style="width: 30%;"><?php echo $relatorio->empresa; ?></td>
                            <td class="text-center" style="width: 25%;"><?php echo $relatorio->tecnico; ?></td>
