<div class="text-center">
    <h3>Editar texto sobre a empresa</h3>
...
<div class="row">
    <form id="form_novo_parceiro" method="post" action="<?php echo site_url('empresa_painel/salvar'); ?>" enctype="multipart/form-data" >
        <div class="col-md-offset-3 col-md-6 col-sm-6">
            <div class="form-group">
                <label for="nome">Nome</label>
                <input type="text" class="form-control" id="nome" name="nome" placeholder="Nome da empresa" value="<?php echo $empresa->nome;?>">
            </div>
            <div class="form-group">
                <label for="endereco">Endereço</label>
                <input type="text" class="form-control" id="endereco" name="endereco" placeholder="Endereço da empresa" value="<?php echo $empresa->endereco;?>">
            </div>
            <div class="form-group">
                <label for="telefone">Telefone</label>
                <input type="text" class="form-control" id="telefone" name="telefone" placeholder="Telefone da empresa"value="<?php echo $empresa->telefone;?>">
            </div>
            <div class="form-group">
                <label for="email">Email</label>
                <input type="text" class="form-control" id="email" name="email" placeholder="Email da empresa" value="<?php echo $empresa->email;?>">
            </div>
            <div class="form-group">
                <label for="descricao">Descrição</label>
                <textarea class="form-control" id="descricao" name="descricao" placeholder="Descreva a empresa aqui" rows="10"><?php echo $empresa->descricao;?></textarea>
            </div>
...
<div class="row text-center" style="margin-top: 30px;">
    ...
    <form id="fileupload" action="<?php echo site_url('empresa_painel/do_upload'); ?>" method="POST" enctype="multipart/form-data">
