<div class="row">
    <h2 class="text-center">Nova categoria</h2>
</div>
...
<div>
    ...
    <?php } ?>
    <form id="form_nova" class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo site_url('acessoria_painel/categ_novo_submit');?>">
        <div class="form-group">
            <label for="categoria" class="control-label col-md-4">Nome:</label>
            <div class="col-md-5">
                <input type="text" class="form-control" id="categoria" name="categoria" placeholder="Digite aqui o nome da categoria">
            </div>
        </div>
         <div class="form-group">
            ...
            <div class="text-center">
                <img id="banner_home_img" style="width: 150px; height: 150px; margin-top: 10px;"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="text-center">
                <img id="banner_img" style="width: 100%; margin-top: 10px;">
            </div>
        </div>
        <div class="text-center">
